...
* [jslatts/nodechat](https://github.com/jslatts/nodechat) - using node.js, socket.io, backbone.js, and jade to make a chat app demo. Demo @ http://nodechat.no.de/ *(archived)*
...
* [Esri/arcgis-samples-flex](https://github.com/Esri/arcgis-samples-flex) - Basic API samples for the ArcGIS API for Flex *(archived)*
* [perfume-dev/example-flash](https://github.com/perfume-dev/example-flash)
...
* [johnlindquist/johnlindquist.com-deprecated](https://github.com/johnlindquist/johnlindquist.com-deprecated) - a place to drop demo code from johnlindquist.com
...
* [ccoenraets/MobileTrader](https://github.com/ccoenraets/MobileTrader)
...
* [joshtynjala/starling-preloader](https://github.com/joshtynjala/starling-preloader) - An example preloader for Starling Framework running in Adobe Flash Player in a web browser *(archived)*
...
* [ccoenraets/SalesbuilderMobile](https://github.com/ccoenraets/SalesbuilderMobile)
* [dima/soup](https://github.com/dima/soup) - Mixing CouchDB, Sinatra, AIR and RestfulX to create an offline/online ready app with undo/redo capabilities. *(archived)*
* [openfl/openfl-samples-as3](https://github.com/openfl/openfl-samples-as3) - OpenFL npm sample projects (written in ActionScript 3.0 with Apache Royale)
...
* [BabelFx/AS3-Flex-Samples](https://github.com/BabelFx/AS3-Flex-Samples) - Flex 3/4 sample applications to demonstrate usages of the BabelFx (l10nInjection) framework *(archived)*
* [keim/wonderfl](https://github.com/keim/wonderfl) - All of my Flash experiments in Wonderfl.
...
* [adobe/avmplus](https://github.com/adobe/avmplus) - Source code for the Actionscript virtual machine *(archived)*
...
* [Lerc/freepascal](https://github.com/Lerc/freepascal) - Free Pascal Compiler - open source compiler for Pascal and Object Pascal
...
* [joshtynjala/monsterdebugger-client-starling](https://github.com/joshtynjala/monsterdebugger-client-starling) - Fork of Monster Debugger client library with support for Starling Framework *(archived)*
* [demonsters/monsterdebugger](https://github.com/demonsters/monsterdebugger) - De Monster Debugger was created by Digital Design Agency De Monsters Amsterdam to assist in debugging applications created in Flash, Flex and AIR.
...
* [dima/restfulx_framework](https://github.com/dima/restfulx_framework) - The RESTful way to develop Adobe Flex and AIR applications. *(archived)*
...
* [stevensacks/Gaia-Framework](https://github.com/stevensacks/Gaia-Framework) - Gaia Framework for Adobe Flash *(archived)*
...
* [pechemann/hummingbird](https://github.com/pechemann/hummingbird) - The easiest way to build and deploy robust MVC applications for ActionScript 3.0, Mobile and the Starling Framework. *(archived)*
* [vishvish/BirdBase](https://github.com/vishvish/BirdBase) - AS3 Microsite Framework - Birdbase is stable and we're about to launch a production site with it, so that seems like a good point to go 1.0. But we need to write some docs and guides to really hit that. And maybe some tests. *(archived)*
...
* [hydrotik/QueueLoader](https://github.com/hydrotik/QueueLoader) - QueueLoader is an easy to use Flash Actionscript (3.0) asset loading utility with a number of features. *(archived)*
* [susisu/Twitter-for-AS3](https://github.com/susisu/Twitter-for-AS3) - (no longer maintained) ActionScript3 library for Twitter API v1.1 *(archived)*
...
* [jon4s-creative/Multipart.as](https://github.com/jon4s-creative/Multipart.as) - AS3 multipart form data request generator
* [Evernote/evernote-sdk-as3](https://github.com/Evernote/evernote-sdk-as3) - Evernote SDK for ActionScript *(archived)*

### Frontend and UI Components

* [AVapps/FileReader](https://github.com/AVapps/FileReader) - A FileReader polyfill for Internet Explore and Safari using Flash *(archived)*
* [WordPress/secure-swfupload](https://github.com/WordPress/secure-swfupload) - A fork of the long-abandoned SWFUpload project, maintained by WordPress and others to ensure that a secure version of SWFUpload exists. Report security vulnerabilities to swfupload-security@wordpress.org. *(archived)*
* [luwes/js-cover-flow](https://github.com/luwes/js-cover-flow) - A Cover Flow component made for the web
* [ispringsolutions/Player-SDK](https://github.com/ispringsolutions/Player-SDK) - iSpring Flash and HTML5 Presentation Player SDK
* [talltyler/HTMLWrapper](https://github.com/talltyler/HTMLWrapper) - An HTML / CSS renderer created in ActionScript
* [danifbento/SWFUpload](https://github.com/danifbento/SWFUpload) - SWFUpload - Fork from SWFUpload Build 2.2.1
...
* [GetBreeze/breeze-db](https://github.com/GetBreeze/breeze-db) - Library and ORM for SQLite in AIR projects
* [SimonRichardson/as3-spod](https://github.com/SimonRichardson/as3-spod) - AS3/AIR Spod api for Simple Persistent Objects Database Library *(archived)*

### Serialization and Formats

* [claus/as3swf](https://github.com/claus/as3swf) - Low level Actionscript 3 library to parse, create, modify and publish SWF files. *(archived)*
* [claus/fzip](https://github.com/claus/fzip) - FZip is an Actionscript 3 class library to load, modify and create standard ZIP archives. *(archived)*
...
* [djw/as3xls](https://github.com/djw/as3xls) - Fork of as3xls with bugfixes (unmaintained) *(archived)*
* [Atry/protoc-gen-as3](https://github.com/Atry/protoc-gen-as3) - Automatically exported from code.google.com/p/protoc-gen-as3
...
* [Tastenkunst/AIRKinectv2](https://github.com/Tastenkunst/AIRKinectv2) - Adobe AIR native extension for Microsofts Kinect v2 for Windows SDK
...
* [jonbuffington/juicekit](https://github.com/jonbuffington/juicekit) - Provides technology used to build engaging Information Experiences (TM). *(archived)*
* [joshtynjala/flextreemap](https://github.com/joshtynjala/flextreemap) - TreeMap data visualization component for Adobe Flex *(archived)*
* [VisualDataWeb/RelFinder](https://github.com/VisualDataWeb/RelFinder) - Interactive Relationship Discovery in RDF Data *(archived)*
...
* [ramonfontes/vnd](https://github.com/ramonfontes/vnd) - Visual Network Description
* [sinnus/socket.io-flash](https://github.com/sinnus/socket.io-flash) - Flash client for Socket.IO server
* [reyco1/as3mul](https://github.com/reyco1/as3mul) - AS3 Multiuser Library
...
* [feathersui/feathersui-starling](https://github.com/feathersui/feathersui-starling) - User interface components for Starling Framework, ActionScript 3, and Adobe AIR
...
* [flex-users/flexlib](https://github.com/flex-users/flexlib) - Open Source Flex components library. *(archived)*
...
* [fairygui/FairyGUI-as3](https://github.com/fairygui/FairyGUI-as3) - A flexible UI framework for Flash AS3
* [theflashbum/fcss](https://github.com/theflashbum/fcss) - Flash Cascading StyleSheet Library
* [reflex/reflex-framework](https://github.com/reflex/reflex-framework) - Complete RIA component framework *(archived)*
* [fairygui/FairyGUI-starling](https://github.com/fairygui/FairyGUI-starling) - A flexible UI framework for Starling.
...
* [ZwickTheGreat/feathers-maps](https://github.com/ZwickTheGreat/feathers-maps) - Google (and more) maps for Starling and Feathers.
...
* [CC-Archived/flex-extensions](https://github.com/CC-Archived/flex-extensions) - A collection of Adobe Flex user interface components, charting controls and elements, behaviors, data types and utility classes and methods. *(archived)*
* [flexlite/framework](https://github.com/flexlite/framework) - an Open Source UI Framework for Flash Games! （已停止维护）
...
* [razorberry/razor](https://github.com/razorberry/razor) - Razor UI components for Actionscript 3 *(archived)*
...
* [Flextras/FlextrasComponents](https://github.com/Flextras/FlextrasComponents)
* [joshtynjala/flexwires](https://github.com/joshtynjala/flexwires) - Drag-and-drop wiring UI for Adobe Flex *(archived)*
* [Esri/quickstart-map-library-flex](https://github.com/Esri/quickstart-map-library-flex) - Easy mapping for Flex developers - Open Source project demonstrating the powers of the ArcGIS API for Flex *(archived)*
* [schlangster/skyui-lib](https://github.com/schlangster/skyui-lib) - A redistributable UI library for Skyrim.
* [badu/SparkComponents](https://github.com/badu/SparkComponents) - Missing Spark Components on Flex SDK 4.6.0 *(archived)*
...
* [kjennis/CrestronSmartGraphics](https://github.com/kjennis/CrestronSmartGraphics) - public repository for Crestron Smart Objects.
* [marpies/material-design-spinner](https://github.com/marpies/material-design-spinner) - Material design spinner for apps powered by Starling and Feathers
...
* [reprise/reprise-framework](https://github.com/reprise/reprise-framework) - CSS based AS3 GUI framework *(archived)*
...
* [blackberry/WebWorks-TabletOS](https://github.com/blackberry/WebWorks-TabletOS) - BlackBerry WebWorks for Tablet OS is a platform for building deeply integrated web applications for the BlackBerry PlayBook *(archived)*
* [elfin8er/Scratch-Mobile](https://github.com/elfin8er/Scratch-Mobile)
...
* [myflashlab/webView-ANE](https://github.com/myflashlab/webView-ANE) - This air native extension is a perfect replacement to the classic StageWebView and it allows you to easily call Javascript functions from flash and send String messages from JS to flash. *(archived)*
...
* [quick6black/flex-Android-Material-Skins](https://github.com/quick6black/flex-Android-Material-Skins) - Android Material Skins for Flex Mobile *(archived)*
* [tuarua/Firebase-ANE](https://github.com/tuarua/Firebase-ANE) - Firebase Adobe Air Native Extension for iOS 12.2+ and Android 19+. Includes OneSignal and Google SignIn
* [myflashlab/facebook-ANE](https://github.com/myflashlab/facebook-ANE) - This air native extension is your best solution to integrate Facebook SDK into your AdobeAir apps *(archived)*
...
* [scratchfoundation/scratch-flash](https://github.com/scratchfoundation/scratch-flash) - Open source version of the Scratch 2.0 project editor. This is the basis for the online and offline versions of Scratch found on the website. *(archived)*
* [FerryYoungFan/VirtualCockroach](https://github.com/FerryYoungFan/VirtualCockroach) - 一只蟑螂桌面“宠物” Cockroach Desktop "Pet"
* [Makeblock-official/mBlock](https://github.com/Makeblock-official/mBlock) - base on scratch offline v2.0 by MIT, Learn more from Makeblock official website
* [Esri/arcgis-viewer-flex](https://github.com/Esri/arcgis-viewer-flex) - Source code for ArcGIS Viewer for Flex - a great application framework for web applications. *(archived)*
* [destroytoday/destroytwitter](https://github.com/destroytoday/destroytwitter) - a lightweight, multi-platform Twitter client
* [icode/DocViewer](https://github.com/icode/DocViewer) - 一个文档在线阅读的JAVA企业级解决方案 *(archived)*
* [flexpaper/flexpaper](https://github.com/flexpaper/flexpaper) - FlexPaper Flex SDK. This project provides a light weight web based PDF viewer component enabling documents be viewed without having any PDF reader software installed. This project provides both Flex library and stand-alone web version. For more information see https://flowpaper.com
* [alienmelon/Electric-Zine-Maker](https://github.com/alienmelon/Electric-Zine-Maker) - source for the Electric Zine Maker
* [Bietol/HalfneMiku](https://github.com/Bietol/HalfneMiku) - Halfne Miku Studio
* [FerryYoungFan/SoManyRoaches](https://github.com/FerryYoungFan/SoManyRoaches) - 满满一桌面的小强！
* [openstreetmap/potlatch2](https://github.com/openstreetmap/potlatch2) - Potlatch 2 OpenStreetMap Editor
...
* [bashtovoi/motivate-clock-desktop](https://github.com/bashtovoi/motivate-clock-desktop) - Motivate Clock Desktop App
* [Lachhh/LachhhTools](https://github.com/Lachhh/LachhhTools) - "In your face" alerts for streamers on Tiwtch!
...
* [enricoberti/napkee](https://github.com/enricoberti/napkee) - Napkee exports Balsamiq Mockups to Twitter Bootstrap at a click of a button.
* [systemed/potlatch3](https://github.com/systemed/potlatch3) - OpenStreetMap editor for desktop
...
* [SSW-SCIENTIFIC/NNDD](https://github.com/SSW-SCIENTIFIC/NNDD) - ニコニコ動画専用クライアントNNDD with DMC対応 forked from https://ja.osdn.net/projects/nndd/ *(archived)*
...
* [motchy869/marmelo](https://github.com/motchy869/marmelo) - 回路図エディタ marmelo
...
* [bigbluebutton/bbb-air-client](https://github.com/bigbluebutton/bbb-air-client) - *(archived)*
...
* [leonardoamx/pomodairo](https://github.com/leonardoamx/pomodairo) - An Adobe Air application for working with the Pomodoro technique. Originally hosted at code.google.com/p/pomodairo
...
* [born2net/signageplayer-core](https://github.com/born2net/signageplayer-core)
...
* [Yatko/video-chat](https://github.com/Yatko/video-chat) - Automatically exported from code.google.com/p/video-chat
...
* [LePtC/AutoAni](https://github.com/LePtC/AutoAni) - 免编译自适应 swf 可视化模版
...
* [LePtC/FlashAni](https://github.com/LePtC/FlashAni) - Flash Animation template
...
* [matrix3d/spriteflexjs](https://github.com/matrix3d/spriteflexjs) - spriteflexjs ,a html5 engine build with apache-royale.
...
* [awaytools/AwayBuilder](https://github.com/awaytools/AwayBuilder)
...
* [BobLChen/Monkey](https://github.com/BobLChen/Monkey) - flash3d stage3d 3d
...
* [zeh/ztween](https://github.com/zeh/ztween) - A simple tweening library. Its main feature is not having many features. *(archived)*
* [danro/tweenman-as3](https://github.com/danro/tweenman-as3) - TweenMan AS3 tweening library for Flash & Flex
* [zadvorsky/starling_lighting_extension](https://github.com/zadvorsky/starling_lighting_extension)
* [nosir/pixas](https://github.com/nosir/pixas) - ActionScript library for building isometric pixel elements
* [eternauta1337/agalthemean](https://github.com/eternauta1337/agalthemean) - Real time AGAL shader editor based on Minimole.
* [a24/Tween24](https://github.com/a24/Tween24)
...
* [binouze/HTMLBitmapFonts](https://github.com/binouze/HTMLBitmapFonts) - Starling extension for using bitmap fonts with simplified html for styling texts
* [mayakwd/as3-eaze-tween](https://github.com/mayakwd/as3-eaze-tween) - Eaze Tween: smart, fast, chainable and compact Flash AS3 tweening library
...
* [dianbaer/MMORPG](https://github.com/dianbaer/MMORPG) - MMORPG是一个可以用来学习ARPG核心战斗的项目（不再维护）。http://v.youku.com/v_show/id_XOTE5NDg1MTg0.html?firsttime=0
* [tinyspeck/glitch-avatars](https://github.com/tinyspeck/glitch-avatars) - Art and source for Glitch's customizable avatars *(archived)*
...
* [tinyspeck/glitch-items](https://github.com/tinyspeck/glitch-items) - Items, Inhabitants, and other assorted things from www.glitchthegame.com *(archived)*
* [tinyspeck/glitch-client](https://github.com/tinyspeck/glitch-client) - Source for the Flash-based Glitch client *(archived)*
* [Ruin0x11/ElonaPlusCustom-GX](https://github.com/Ruin0x11/ElonaPlusCustom-GX) - Elona+ variant based on Custom-G
* [hsharma-design/Hungry-Hero](https://github.com/hsharma-design/Hungry-Hero) - Hungry Hero is an open source Flash game built on Starling Framework.
...
* [MaddyThorson/Ogmo-Editor-v1](https://github.com/MaddyThorson/Ogmo-Editor-v1) - Generic level and tilemap editor for indie game developers!
...
* [mindjolt/starling-builder-editor](https://github.com/mindjolt/starling-builder-editor)
...
* [wdmir/521266750_qq_com](https://github.com/wdmir/521266750_qq_com) - massive multiplayer platform for poker online game
* [jwagner/box2d2-js](https://github.com/jwagner/box2d2-js) - Automatic port of box2dAS 2.0 to javascript
* [pnkl1999/DDTank41](https://github.com/pnkl1999/DDTank41) - Full Source DDTank Version 41
* [dofera/dofedex](https://github.com/dofera/dofedex) - A Dofus Retro encyclopedia
...
* [Ormael13/CoCX](https://github.com/Ormael13/CoCX) - Coc source from Fenoxo with Xianxia twist and not only ^^
* [punkice3407/ObjectBuilder](https://github.com/punkice3407/ObjectBuilder)
...
* [5DPLAY-Game-Studio/BleachVsNaruto](https://github.com/5DPLAY-Game-Studio/BleachVsNaruto) - 死神vs火影 是一个由 剑jian 及其所属制作组 5DPLAY Game Studio 制作的同人新概念策略格斗游戏。 在这里，你可以挑战自己操作与反应的极限，也可以作为团队的核心决策这体验运筹帷幄的畅快。
* [tdavies/Ember](https://github.com/tdavies/Ember) - Flash component based entity system framework for game development
* [133spider/AQLite](https://github.com/133spider/AQLite) - A Client for AQWorlds
...
* [sticks-stuff/CPSC](https://github.com/sticks-stuff/CPSC) - Club Penguin Singleplayer Client *(archived)*
* [claus/fc64](https://github.com/claus/fc64) - A low level Commodore 64 emulator written in Actionscript 3 *(archived)*
* [monicanagent/cypherpoker](https://github.com/monicanagent/cypherpoker) - An open source implementation of peer to peer cryptographic poker ("Mental Poker")
...
* [ottools/ObjectBuilder](https://github.com/ottools/ObjectBuilder)
...
* [doodlum/SkyUI-Community](https://github.com/doodlum/SkyUI-Community) - Community update of SkyUI (6.0+) with modern improvements and fixes
...
* [pixeljam/DinoRunDX](https://github.com/pixeljam/DinoRunDX)
* [AntKarlov/Anthill-Framework](https://github.com/AntKarlov/Anthill-Framework) - Tiny framework for creating Flash games.
* [bot4dofus/Datafus](https://github.com/bot4dofus/Datafus) - 📚🥚 The Dofus database and socket events in JSON files. Includes the source code and more... *(archived)*
...
* [map220v/TencentPvZOL](https://github.com/map220v/TencentPvZOL)
...
* [zeh/key-action-binder-as3](https://github.com/zeh/key-action-binder-as3) - A keyboard/gamepad binder for easier game input in ActionScript *(archived)*
* [cykoder/oni](https://github.com/cykoder/oni) - OLD, NOT SUPPORTED - ActionScript 3 game engine
* [CSmxl001/catchfish](https://github.com/CSmxl001/catchfish)
...
* [Seb-135/ee-offline](https://github.com/Seb-135/ee-offline) - Source for Everybody Edits: Offline
* [carykh/5b](https://github.com/carykh/5b) - Flash game I developed in early 2013, first announced in this YouTube video: https://www.youtube.com/watch?v=emDpKog8v6w
* [NoRabbit/ND2Dx](https://github.com/NoRabbit/ND2Dx) - 2D GPU Accelerated Game Engine for Flash Stage3D
* [poerlang/HEditor](https://github.com/poerlang/HEditor) - A Html5 Web Game Editor
...
* [TylerGlaiel/GlaielGamesOldFlashSources](https://github.com/TylerGlaiel/GlaielGamesOldFlashSources) - a release of the source code for all my old flash games, for educational & preservation purposes only
* [amitp/mapgen](https://github.com/amitp/mapgen) - Simple game map generator using Perlin/Simplex noise. Used for alpha testing of Realm of the Mad God.
...
* [sxmad/MarbleMap-RPG-Game-Map-Editor](https://github.com/sxmad/MarbleMap-RPG-Game-Map-Editor) - map editor for rpg games.export json config file.
...
* [Gamua/Starling-Extension-Adobe-Animate](https://github.com/Gamua/Starling-Extension-Adobe-Animate) - An extension for Starling that allows to load and display animations exported from Adobe Animate CC.
...
* [tylerzhu/linkupGame](https://github.com/tylerzhu/linkupGame) - 基于PureMVC实现的连连看小游戏
...
* [zynga/swf2ccb](https://github.com/zynga/swf2ccb) - [DEPRECATED] A tool that converts existing assets to ccb format *(archived)*
...
* [totologic/daedalus-lib](https://github.com/totologic/daedalus-lib) - Dynamic pathfinding in dynamic environment library
...
* [nashnie/Guide](https://github.com/nashnie/Guide) - 数据驱动的新手引导系统
...
* [boycy815/fastAStar](https://github.com/boycy815/fastAStar) - 超快速4方向A*寻路
* [matrix3d/patrollaya](https://github.com/matrix3d/patrollaya) - navmesh for laya
* [SometimesRain/crazyclient](https://github.com/SometimesRain/crazyclient) - A hacked client for Realm of the Mad God.
...
* [PushButtonLabs/PushButtonEngine](https://github.com/PushButtonLabs/PushButtonEngine) - An open source Flash game framework built around a Component-Entity system. *(archived)*
* [Scrivener07/FO4_Games](https://github.com/Scrivener07/FO4_Games) - Play classic games in Fallout 4.
* [TerryCavanagh/chatchat](https://github.com/TerryCavanagh/chatchat) - Become a cat! The source code for my little 2012 multiplayer catroom game. Co-created with Hayden Scott-Baron (@docky).
* [tomnewton/AS3AStar](https://github.com/tomnewton/AS3AStar) - Fast actionscript 3 astar pathfinding algorithm.
* [zmcj21/boxhead_res](https://github.com/zmcj21/boxhead_res)
...
* [emmettbutler/how-do-you-Do-It](https://github.com/emmettbutler/how-do-you-Do-It) - Game about dolls made for 2014 Global Game Jam NYC
* [fastlorisstudios/AIROUYAController](https://github.com/fastlorisstudios/AIROUYAController) - AIR Native Extension for the OUYA Controller *(archived)*
...
* [rafaelroballo2/pigeon](https://github.com/rafaelroballo2/pigeon) - Catch the Pigeon - Social Game
...
* [TerryCavanagh/boscaceoil](https://github.com/TerryCavanagh/boscaceoil) - A simple music making program *(archived)*
...
* [neolao/mp3-player](https://github.com/neolao/mp3-player) - MP3 Player *(archived)*
* [DigitalStrawberry/ANE-Sounds](https://github.com/DigitalStrawberry/ANE-Sounds) - Air Native Extension (ANE) to play sounds on Android
...
* [laurentvd/wavesurfer.swf](https://github.com/laurentvd/wavesurfer.swf) - Flash fallback for wavesurfer.js *(archived)*
...
* [Tencent/Fanvas](https://github.com/Tencent/Fanvas) - Fanvas，一键把swf转为html5 canvas动画。 Fanvas is a tool which can turn flash into canvas animation with just one key! *(archived)*
* [infusion/jQuery-webcam](https://github.com/infusion/jQuery-webcam) - A webcam wrapper plugin for jQuery
* [flowplayer/flash](https://github.com/flowplayer/flash) - Flowplayer Flash, the video player for the Web *(archived)*
* [ccallcn/ovmeet](https://github.com/ccallcn/ovmeet) - SIP视频对讲、MCU融屏、指挥调度 、网页视频会议、视频会议、H5视频直播、SIP广播会议、融合通信、WebRtc、RTMP、SIP、RTSP、白板、视频录制、视频通话、旁路直播、AR眼镜、执法记录仪、AR专家系统、AR远程协助、AR巡检、远程医疗、视频安全帽、机顶盒
...
* [chxj1992/rtmp-streamer](https://github.com/chxj1992/rtmp-streamer) - 浏览器RTMP推流SDK (A javascript rtmp streamer library)
...
* [AxisCommunications/locomote-video-player](https://github.com/AxisCommunications/locomote-video-player) - Media Player in Adobe Flash with RTSP support. (THIS PROJECT IS NO LONGER MAINTAINED) *(archived)*
...
* [gokerDEV/f4player](https://github.com/gokerDEV/f4player) - f4Player :: Open Source AS3 Flash Video Player
* [FlashJunior/OSFlashVideoPlayer](https://github.com/FlashJunior/OSFlashVideoPlayer) - Open source flash video player An embeddable "all in one" Player (FLV, F4V, MOV, MP4, vimeo and youtube).
* [video-dev/clappr-rtmp-plugin](https://github.com/video-dev/clappr-rtmp-plugin) - 📺 RTMP support for Clappr player.
* [castlabs/dashas](https://github.com/castlabs/dashas) - MPEG-DASH player written in ActionScript *(archived)*
...
* [denivip/StrobeMediaPlayback](https://github.com/denivip/StrobeMediaPlayback) - StrobeMediaPlayback video player which is maintained by DENIVIP team
* [nathanhinish/AS3-IABLib](https://github.com/nathanhinish/AS3-IABLib) - An ActionScript 3 library for IAB specs. Includes the following features: VAST 2.0 Spec (http://www.iab.net/vast) for parsing VAST responses. VPAID Spec (http://www.iab.net/vpaid) for creating VPAID-compliant ads. *(archived)*
* [neolao/flv-player](https://github.com/neolao/flv-player) - FLV Player *(archived)*
* [minosss/codec-as3](https://github.com/minosss/codec-as3) - [DEPRECATED] :arrows_counterclockwise: AS3視頻封裝解析~FLV, MP4 *(archived)*
...
* [myflashlab/videoPlayer-ANE](https://github.com/myflashlab/videoPlayer-ANE) - video player air native extension supported on Android and iOS lets you play video files in android or iOS players. your videos can be locally availble on your device or they can be online. *(archived)*
...
* [mroth/cameraform](https://github.com/mroth/cameraform) - :video_camera: Simple Flash+JS library for webcam capture and submission. *(archived)*
...
* [thatguystone/flowplayer-ima](https://github.com/thatguystone/flowplayer-ima) - A simple Interactive Media Ads plugin for FP *(archived)*
* [gnss-pro/flash-player](https://github.com/gnss-pro/flash-player) - 部标流媒体flash播放器
...
* [luo-kai-wen/HLSPlayer](https://github.com/luo-kai-wen/HLSPlayer) - 基于Flash插件的HLS播放器，支持VTT缩略图，SRT字幕等
* [shin10/Starling-Video](https://github.com/shin10/Starling-Video) - DisplayObject for Videos in Starling
* [LeeBurrows/Async-Image-Encoders](https://github.com/LeeBurrows/Async-Image-Encoders) - Asynchronously encode BitmapData objects into image file format *(archived)*
...
* [7dog7/flash-hijack](https://github.com/7dog7/flash-hijack) - flash 劫持轮子，CSRF，劫持，跳转，swf 有需求可以提issues ，src挖掘,劫持response
* [sethsec/crossdomain-exploitation-framework](https://github.com/sethsec/crossdomain-exploitation-framework) - Everything you need to exploit overly permissive crossdomain.xml files
...
* [riusksk/FlashScanner](https://github.com/riusksk/FlashScanner) - Flash XSS Scanner
...
* [JordanMilne/YMail-Pineapple](https://github.com/JordanMilne/YMail-Pineapple) - Tools for MITMing Yahoo! Mail with a Wifi Pineapple Mark V and Flash
...
* [CC-Archived/promise-as3](https://github.com/CC-Archived/promise-as3) - Promises/A+ compliant implementation in ActionScript 3.0 *(archived)*
...
* [myflashlab/easyAS-Worker](https://github.com/myflashlab/easyAS-Worker) - Run AS worker in your AdobeAir projects without having to deal with complicated flash.system.Worker class
...
* [mde/flex-pilot](https://github.com/mde/flex-pilot) - Testing automation library for Flex and Flash.
...
* [BabelFx/AS3-Flex-Library](https://github.com/BabelFx/AS3-Flex-Library) - BabelFx localization (l10n) library implemented as extensions to the Flex Swiz IoC framework (v1.x) *(archived)*
...
* [tschneidereit/SwiftSuspenders](https://github.com/tschneidereit/SwiftSuspenders) - NOTE: Find the offical repo at http://github.com/robotlegs/swiftsuspenders *(archived)*
...
* [zeh/as3](https://github.com/zeh/as3) - A bunch of reusable junk for my own work. Pretty much reinventing the wheel, forever. *(archived)*
...
* [sammyt/dawn](https://github.com/sammyt/dawn) - lightweight dependency injection for actionscript *(archived)*
* [amacdougall/underscore.as](https://github.com/amacdougall/underscore.as) - An AS3 port of underscore.js
* [EliEladElrom/eladlib](https://github.com/EliEladElrom/eladlib) - This collection is Elad Elrom's private library of Adobe Action Script 3.0 APIs for Adobe Flex and AIR.
...
* [SimonRichardson/as3-mixins](https://github.com/SimonRichardson/as3-mixins) - Create real mixins using bytecode injection at runtime. *(archived)*
* [zrong/as3](https://github.com/zrong/as3) - zengrong.org编写的一些AS小工具
* [sammyt/fussy](https://github.com/sammyt/fussy) - actionscript reflection query language *(archived)*
* [nodename/Ultimate-Enum](https://github.com/nodename/Ultimate-Enum) - The ultimate enum for AS3
* [storagecart/Tool-library-for-as3](https://github.com/storagecart/Tool-library-for-as3) - a tool library for actionscript3.0
...
* [AS3Commons/as3commons-lang](https://github.com/AS3Commons/as3commons-lang)
* [reintroducing/as3](https://github.com/reintroducing/as3) - This library contains a portion of my AS3 classes that I use almost every day. *(archived)*

## Business and Domain

### Business and Productivity

* [SpikeApp/Spike](https://github.com/SpikeApp/Spike) - Get The Most Out Of Your CGM Transmitter
* [JohanDegraeve/iosxdripreader](https://github.com/JohanDegraeve/iosxdripreader) - xdrip/xbridge reader for iOS devices *(archived)*
* [InteractiveAdvertisingBureau/openvv](https://github.com/InteractiveAdvertisingBureau/openvv)
...
* [TheAllenChou/numeric-springing](https://github.com/TheAllenChou/numeric-springing) - Precise & designer-friendly numeric springing algorithms
...
* [zengfeng/books](https://github.com/zengfeng/books) - books
* [scottschiller/arduino.js](https://github.com/scottschiller/arduino.js) - Experimental JavaScript-to-Arduino I/O. Implemented as a wrapper for the "AS3Glue" library (Rube Goldberg-esque stack: JavaScript <-> Flash <-> Socket/serial proxy <-> Arduino USB.) Next steps / fork ideas: NodeJS + WebSocket instead of socket proxy + Flash? *(archived)*
...
* [timkurvers/as3-crypto](https://github.com/timkurvers/as3-crypto) - Fork of Henri Torgemane's excellent as3 cryptography library *(archived)*
...
* [myflashlab/Firebase-ANE](https://github.com/myflashlab/Firebase-ANE) - Firebase ANE collection give you access to the Google Firebase project in your AdobeAir projects supported on both Android and iOS with 100% identical ActionScript API. *(archived)*
...
* [EliEladElrom/Flash-Optimizing-Tools](https://github.com/EliEladElrom/Flash-Optimizing-Tools) - Flash Optimizing Tools
...
* [distintiva/eBlock](https://github.com/distintiva/eBlock) - Scratch application to program micro:bit, arduino and other devices based on mBlock 3.4.5 and improved with a lot of new features
* [mikedotalmond/napoleon](https://github.com/mikedotalmond/napoleon) - *(archived)*
* [justdionysus/gcwoah](https://github.com/justdionysus/gcwoah)
...
* [EliEladElrom/robotlegs-utilities-AntGenerator](https://github.com/EliEladElrom/robotlegs-utilities-AntGenerator) - Lightweight Ant script extensions generator for Robotlegs following best practices.
...
* [MixingLoom/mixingloom-core](https://github.com/MixingLoom/mixingloom-core)
* [SmashIO/SmashFramework](https://github.com/SmashIO/SmashFramework)
* [Neanka/MCM_0.1_AS3](https://github.com/Neanka/MCM_0.1_AS3)
...
* [jankeesvw/LogMeister](https://github.com/jankeesvw/LogMeister) - LogMeister, one Flash logger to rule them all *(archived)*
...
* [saharan/OGSL](https://github.com/saharan/OGSL)
...
* [Lindi/Nevada-Railroad](https://github.com/Lindi/Nevada-Railroad) - Nevada Railroad Interactive
* [velara3/flexcapacitor](https://github.com/velara3/flexcapacitor)
...
* [srohde/Twitter](https://github.com/srohde/Twitter)
...
* [articulate/storyline-sdk](https://github.com/articulate/storyline-sdk) - *(archived)*
* [cicl-stanford/csm](https://github.com/cicl-stanford/csm) - Contains all materials for the paper "A counterfactual simulation model of causal judgment".
* [satoshi7/ActionScript-API-for-AWS-Amazon-Web-Services-](https://github.com/satoshi7/ActionScript-API-for-AWS-Amazon-Web-Services-)
* [victorfmaraujo/pfsense-aliases](https://github.com/victorfmaraujo/pfsense-aliases)
...
* [ga1ois/Recon-2018-Montreal](https://github.com/ga1ois/Recon-2018-Montreal)
* [Jack000/PartKAM](https://github.com/Jack000/PartKAM) - A browser-based 2.5D CAM tool
...
* [circuitvalley/IR-Remote-Control](https://github.com/circuitvalley/IR-Remote-Control) - NEC IR Decoder/ Reciver Libarary in C For Microcontroller
...
* [myflashlab/inAppPayments-ANE](https://github.com/myflashlab/inAppPayments-ANE) - Identical in-app-billing and in-app-purchase Air Native Extension for Android and iOS *(archived)*
* [ranklau/labs](https://github.com/ranklau/labs)
